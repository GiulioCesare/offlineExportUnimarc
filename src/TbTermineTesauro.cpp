...
TbTermineTesauro::TbTermineTesauro(CFile *tbIn, CFile *tbOffsetIn, char *offsetBufferTbPtr, long elementsTb, int keyPlusOffsetPlusLfLength, int key_length) :
...
bool TbTermineTesauro::loadRecord(const char *key)
{
	long position;
	char * entryPtr;
	bool retb;
