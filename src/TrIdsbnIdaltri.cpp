...
TrIdsbnIdaltri::TrIdsbnIdaltri(CFile *tbIn, CFile *tbOffsetIn, char *offsetBufferTbPtr, long elementsTb, int keyPlusOffsetPlusLfLength, int key_length) :
...
bool TrIdsbnIdaltri::loadRecord(const char *key)
{
...
bool TrIdsbnIdaltri::loadNextRecordDaIndice(const char *key, bool inverted)
{
