...
#Export authority titolo dell'opera locale
...
//					printf ("\n\nVersione 11.1.1 24/01/2020");	// crea tag 699 dipendente dalla 606

//					printf ("\n\nVersione 11.4.1 24/04/2020");	// 17/04/2020 Gestione URL in nota all'ISBD
																// Nota ad url puo essere a seguire il separatore (( (inizio nota) o '. - ' all'interno della nota
																// Il campo url della nota puo' contenere piu URL separate da ' ; ' Ogni link puo' avere un commento (opzionale con delimitatore ' | ') ed una url
...
//					printf ("\n\nVersione 12.01.01 22/01/2021"); // gestione Authority Autore, localizzazioni altriDB(999).]
					...
					printf ("\n\nVersione 12.02.01 18/02/2021"); // Fix AUTHORITY_TITOLI_UNIFORMI (// if (POLO.isEqual("INDICE")))
